...
RSpec.describe Model, type: :model do
  context 'validations' do
    ...
    # name and make must be present
      ...
      invalid_1 = Model.new(name: 'Civic', year_id: year.id)
      invalid_2 = Model.new(make_id: 1)
      valid_model = Model.new(name: 'Civic', make_id: make.id, year_id: year.id)
    ...
    # name uniqueness
      invalid_3 = Model.new(name: 'Civic', make_id: make.id, year_id: year.id)
