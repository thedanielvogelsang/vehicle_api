...
RSpec.describe Vehicle, type: :model do
  ...
  context 'validations' do
    ...
    it{is_expected.to validate_presence_of(:year_id)}
    it{is_expected.to validate_presence_of(:vin)}

    it "is created with valid attributes" do
    # is created only with make, model, year, vin #
      invalid_1 = Vehicle.new(model_id: @model.id, year_id: @year.id, vin: "LLDWXZLG77VK2LUUF")
      invalid_2 = Vehicle.new(make_id: @make.id, year_id: @year.id, vin: "LLDWXZLG77VK2LUUF")
      invalid_3 = Vehicle.new(make_id: @make.id, model_id: @model.id, vin: "LLDWXZLG77VK2LUUF")
      invalid_4 = Vehicle.new(make_id: @make.id, model_id: @model.id, year_id: @year.id)
    ...
    # vin numbers must be different
      valid = Vehicle.new(make_id: @make.id, model_id: @model.id, year_id: @year.id, vin: "LLDWXZLG77VK2LUUF")
      invalid_5 = Vehicle.new(make_id: @make.id, model_id: @model.id, year_id: @year.id, vin: "LLDWXZLG77VK2LUUF")
